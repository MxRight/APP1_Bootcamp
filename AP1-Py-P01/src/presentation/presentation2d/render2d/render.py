...
class Render2d:
    ...
    def draw_world(self, stdscr, world_view):
        ...
        # --- 2. Сущности (игрок, враги, предметы)
        ...
        # --- 5. Отображаем кадр одним движением (без мерцания)
        # Ограничиваем область отображения размерами терминала
